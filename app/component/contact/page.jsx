...
export default function Page() {
  useEffect(() => {
    document.title = "Contact | Blood-Donation";
  }, []);
  const router = useRouter();
  return (
    <div className={styles.container}>
      <button className={styles.button} onClick={()=>router.push('/component/HomePage')}>Return Home</button>
